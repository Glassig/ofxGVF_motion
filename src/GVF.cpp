...
GVFOutcomes & GVF::update(vector<float> & observation)
{
    ...
    //std::cout << endl << "one update" << endl;
    
    //std::cout << "likeliest movement " << outcomes.likeliestGesture << endl;
    
    //std::cout << "likelihoods: "<< endl;
    //printVec(outcomes.likelihoods);
    
    //std::cout << "alignments: "<< endl;
    //printVec(outcomes.alignments);
    
    //std::cout << "dynamics: "<< endl;
    //printMat(outcomes.dynamics);
    
    //std::cout << "scalings: "<< endl;
    //printMat(outcomes.scalings);
    
    //std::cout << "rotations: "<< endl;
    //printMat(outcomes.rotations);
